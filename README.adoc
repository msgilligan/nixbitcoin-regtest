...
This is an experimental project to easily configure, deploy, and maintain a Nix Bitcoin RegTest VM for development purposes. It has been tested using Lima to manage the guest VM.
...
If you do not have Nix, you will need to install `lima`, `deloy-rs`, Java 25, etc.
